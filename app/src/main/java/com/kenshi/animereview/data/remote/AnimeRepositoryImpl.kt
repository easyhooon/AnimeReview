...
//                    async { animeService.fetchAnimeById(recommendAnimeIdList[randomIndexList[9]]) }
                ...
                val response1 =
                    async { animeService.fetchAnimeById(recommendAnimeIdList[0]) }
                val response2 =
                    async { animeService.fetchAnimeById(recommendAnimeIdList[1]) }
//                val response3 =
//                    async { animeService.fetchAnimeById(recommendAnimeIdList[2]) }
//                val response4 =
//                    async { animeService.fetchAnimeById(recommendAnimeIdList[3]) }
//                val response5 =
//                    async { animeService.fetchAnimeById(recommendAnimeIdList[4]) }
//                val response6 =
//                    async { animeService.fetchAnimeById(recommendAnimeIdList[5]) }
//                val response7 =
//                    async { animeService.fetchAnimeById(recommendAnimeIdList[6]) }
//                val response8 =
//                    async { animeService.fetchAnimeById(recommendAnimeIdList[7]) }
//                val response9 =
//                    async { animeService.fetchAnimeById(recommendAnimeIdList[8]) }
//                val response10 =
//                    async { animeService.fetchAnimeById(recommendAnimeIdList[9]) }
